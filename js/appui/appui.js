...
(function() {
  ...
  AppUI = class AppUI {
    constructor(app1) {
      ...
      this.setAction("menu-forum", () => {
        return window.open("https://talk.atmocode.ru", "_blank");
      });
      this.setAction("menu-atmocode", () => {
        return window.open("https://atmocode.ru/", "_blank");
      });
      this.setAction("menu-palette", () => {
        return window.open("https://palette.atmocode.ru/", "_blank");
      });
      this.setAction("menu-promo", () => {
        return window.open("https://promo.atmocode.ru/", "_blank");
      });
      this.setAction("menu-assets", () => {
        return window.open("https://assets.atmocode.ru/", "_blank");
      });
      if (window.ms_standalone) {
