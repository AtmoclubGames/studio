class AppUI
  constructor:(@app)->
    ...
    @setAction "menu-palette",()=>
      window.open "https://palette.atmocode.ru/","_blank"

    @setAction "menu-promo",()=>
      window.open "https://promo.atmocode.ru/","_blank"

    @setAction "menu-assets",()=>
      window.open "https://assets.atmocode.ru/","_blank"
