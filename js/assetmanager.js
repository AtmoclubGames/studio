...
this.AssetsManager = (function(superClass) {
  ...
  function AssetsManager(app) {
    ...
    this.extensions = ["glb", "obj", "json", "ttf", "png", "jpg", "txt", "csv", "md", "wasm", "js"];
  ...
  AssetsManager.prototype.loadWasmInitializer = function(assetName, callback) {
    var asset = this.app.project.getAsset(assetName);
    if (asset && asset.ext === "js") {
      var script = document.createElement("script");
      script.src = asset.getURL();
      script.onload = callback;
      script.onerror = (function(_this) {
        return function() {
          console.error("Failed to load JS initializer: " + assetName);
        };
      })(this);
